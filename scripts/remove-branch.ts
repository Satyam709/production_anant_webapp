...
async function main() {
    ...
    if (!rollNo) {
        console.log('Please provide a roll number: npx ts-node scripts/remove-branch.ts <roll_number>');
        return;
    }
    ...
    try {
        ...
        console.log('Now log in as this user to verify the onboarding redirection.');
    } catch (e) {
