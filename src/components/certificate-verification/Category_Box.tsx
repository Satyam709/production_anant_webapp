...
export default function CategoryBox({ category }: { category: string }) {
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-6 cursor-pointer transform transition-all duration-300 hover:scale-[1.02] hover:bg-gray-750 border border-gray-700 group">
