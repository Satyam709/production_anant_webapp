...
const BlogCard: React.FC<BlogCardProps> = ({ blog, onEdit, onDelete, onAccept, onOpen, type }) => {
  return (
      <div 
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-grow">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2 line-clamp-2">{blog.title}</h3>
          <p className="text-gray-600 dark:text-gray-300 text-sm mb-3 line-clamp-3">{blog.description}</p>
