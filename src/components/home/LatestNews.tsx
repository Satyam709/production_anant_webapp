      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {latestNews.map((news, index) => (
            <div key={index} className="bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
              ...
              {news.link && (
                <a href={news.link} className="inline-block mt-4 text-primary-cyan hover:text-primary-blue transition-colors">
                  Read more →
                </a>
              )}
            </div>
