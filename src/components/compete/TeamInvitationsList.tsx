...
const TeamInvitationsList: React.FC<TeamInvitationsListProps> = ({ invitations, onAccept, onReject }) => {
      ...
      {invitations.map((invitation) => (
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold">{invitation.team.team_name}</h3>
