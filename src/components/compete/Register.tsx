    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-xl">
          ...
          {teams.length == 0 && (
            <p>
              Only a team leader can register their team. If you are registered,
              your team leader has done so. If not, you can ask your team leader
              or make your own team in dashboard section. Happy Event!
            </p>
          )}
                ...
                >
                  <div className="flex items-center gap-4">
                    <input
                      ...
                      onChange={() => setSelectedTeam(team.team_id)}
      ...
      <div className="max-w-3xl mx-auto px-4 pb-16">
        ...
        >
          {selectedTeam ? "Register Now" : "Select a Team to Register"}
        </button>
      </div>
    </>
  );
